...
private val translations = mapOf(
    "en" to mapOf(
        ...
        "Lingua" to "Language", "Automatica" to "Automatic", "Tema schermata iniziale" to "Home screen theme", "Classico" to "Classic", "Onde pastello" to "Pastel waves", "Blu scuro" to "Dark blue", "Le preferenze vengono salvate e applicate subito." to "Preferences are saved and applied immediately.",
    ...
    "es" to mapOf(
        ...
        "Nome in classifica" to "Nombre en la clasificación", "Massimo 20 caratteri" to "Máximo 20 caracteres", "Giocatore" to "Jugador", "Lingua" to "Idioma", "Tema schermata iniziale" to "Tema de inicio", "Classico" to "Clásico", "Onde pastello" to "Ondas pastel", "Blu scuro" to "Azul oscuro",
    ...
    "fr" to mapOf(
        ...
        "Nome in classifica" to "Nom au classement", "Massimo 20 caratteri" to "20 caractères maximum", "Giocatore" to "Joueur", "Lingua" to "Langue", "Tema schermata iniziale" to "Thème de l'accueil", "Classico" to "Classique", "Onde pastello" to "Ondes pastel", "Blu scuro" to "Bleu foncé",
    ...
    "de" to mapOf(
        ...
        "Nome in classifica" to "Name in der Rangliste", "Massimo 20 caratteri" to "Maximal 20 Zeichen", "Giocatore" to "Spieler", "Lingua" to "Sprache", "Tema schermata iniziale" to "Startseitenthema", "Classico" to "Klassisch", "Onde pastello" to "Pastellwellen", "Blu scuro" to "Dunkelblau",
