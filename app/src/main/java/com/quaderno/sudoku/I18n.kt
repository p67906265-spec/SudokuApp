...
private val translations = mapOf(
    "en" to mapOf(
        ...
        "Classifica del giorno" to "Daily leaderboard", "partecipanti" to "players", "Posizione" to "Position",
        ...
        "Lingua" to "Language", "Automatica" to "Automatic", "Le preferenze vengono salvate e applicate subito." to "Preferences are saved and applied immediately.",
        "Annulla mossa" to "Undo", "Cancella" to "Erase", "Note" to "Notes", "Suggerimento" to "Hint",
    ...
    "es" to mapOf(
        ...
        "Impostazioni" to "Ajustes", "Statistiche" to "Estadísticas", "Come si gioca" to "Cómo jugar", "Sfida del giorno" to "Reto diario",
        ...
        "Classifica del giorno" to "Clasificación diaria", "partecipanti" to "participantes", "Posizione" to "Posición", "Sfida completata!" to "¡Reto completado!",
        ...
        "Nome in classifica" to "Nombre en la clasificación", "Massimo 20 caratteri" to "Máximo 20 caracteres", "Giocatore" to "Jugador", "Lingua" to "Idioma",
        "Automatica" to "Automático", "Cancella" to "Borrar", "Note" to "Notas", "Suggerimento" to "Ayuda", "Partita in pausa" to "Partida en pausa",
    ...
    "fr" to mapOf(
        ...
        "Impostazioni" to "Paramètres", "Statistiche" to "Statistiques", "Come si gioca" to "Comment jouer", "Sfida del giorno" to "Défi du jour",
        ...
        "Classifica del giorno" to "Classement du jour", "partecipanti" to "participants", "Posizione" to "Position", "Sfida completata!" to "Défi terminé !",
        ...
        "Nome in classifica" to "Nom au classement", "Massimo 20 caratteri" to "20 caractères maximum", "Giocatore" to "Joueur", "Lingua" to "Langue",
        "Automatica" to "Automatique", "Cancella" to "Effacer", "Note" to "Notes", "Suggerimento" to "Indice", "Partita in pausa" to "Partie en pause",
    ...
    "de" to mapOf(
        ...
        "Impostazioni" to "Einstellungen", "Statistiche" to "Statistiken", "Come si gioca" to "Spielanleitung", "Sfida del giorno" to "Tagesaufgabe",
        ...
        "Classifica del giorno" to "Tagesrangliste", "partecipanti" to "Teilnehmer", "Posizione" to "Position", "Sfida completata!" to "Aufgabe geschafft!",
        ...
        "Nome in classifica" to "Name in der Rangliste", "Massimo 20 caratteri" to "Maximal 20 Zeichen", "Giocatore" to "Spieler", "Lingua" to "Sprache",
        "Automatica" to "Automatisch", "Cancella" to "Löschen", "Note" to "Notizen", "Suggerimento" to "Hinweis", "Partita in pausa" to "Spiel pausiert",
